            ...
            <section>
                ...
                <section>
                    ...
                    <li>요소의 이름이 요소의 역할을 충분히 설명하지 못할 때 사용할 수 있습니다.
                        <div role="div 요소" className="button">요소는 div</div>
                    </li>
                ...
                <section>
                    ...
                    <div className="iconButtonContainer">
                        <button className="iconButton"><img src={home} alt="홈"/></button>
                        <button className="iconButton"><img src={web} alt="언어변경"/></button>
                        <button className="iconButton"><img src={mail} alt="메세지"/></button>
                    </div>
                </section>
