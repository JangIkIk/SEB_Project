describe('Object에 대해서 학습합니다.', function () {
  ...
  */
  it('Object의 기본을 확인합니다.', function () {
    ...
    // 객체와 배열은 다르다 배열은 === 0 객체는 === undefined 다 
    // 왜 ???
    // 배열의 인덱스로 통한 접근이 가능하다 array[0] 등등....
    // 하지만 객체는 ?? index개념이 없다.... 키로 접근을하는것이다!!
    // 그렇기때문에 아래의 length는 순서있는 베열의 길이만 표현이가능하다.
  ...
  it('Object를 함수의 전달인자로 전달할 경우, reference가 전달됩니다.', function () {
    ...
    // Object.assign 에 관한내용
    // 빈객체에 obj에 대한내용을 열거!!!
    // 하지만 copiedObj 요소에 obj와 같은내용이있다면 obj의 내용으로 덮어써진다!! 중복요소가 없다면 그값은 추가!!
